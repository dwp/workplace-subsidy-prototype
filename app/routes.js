...
//////////            EMPLOYER VERSION 23.4 (public beta)

//have you registered before

router.post('/phoenix/employer/v23_4/have-you-registered', function (req, res) {
        if (req.session.data['haveRegistered'] === "yes") {
                res.redirect('/phoenix/employer/v23_4/email-address-gate-returning')
        } else {
                res.redirect('/phoenix/employer/v23_4/are-you-eligible')
        }
})
...
router.get(`/phoenix/employer/v23_4/business-name`, function (req, res) {
        res.render(`/phoenix/employer/v23_4/business-name`, {
                data: req.session.data
        })
})

router.post(`/phoenix/employer/v23_4/business-name`, function (req, res) {
        res.redirect(`/phoenix/employer/v23_4/sector`)
})

//sector

router.get(`/phoenix/employer/v23_4/sector`, function (req, res) {
        res.render(`/phoenix/employer/v23_4/sector`, {
                data: req.session.data
        })
})

router.post(`/phoenix/employer/v23_4/sector`, function (req, res) {
        res.redirect(`/phoenix/employer/v23_4/contact-method`)
})

//contact-details
router.get(`/phoenix/employer/v23_4/contact-details`, function (req, res) {
        res.render(`/phoenix/employer/v23_4/contact-details`, {
                data: req.session.data
        })
})

router.post(`/phoenix/employer/v23_4/contact-details`, function (req, res) {
        res.redirect(`/phoenix/employer/v23_4/email-confirm-code-1`)
})

//email-address-gate
router.get(`/phoenix/employer/v23_4/email-address-gate`, function (req, res) {
        res.render(`/phoenix/employer/v23_4/email-address-gate`, {
                data: req.session.data
        })
})

router.post(`/phoenix/employer/v23_4/email-address-gate`, function (req, res) {
        res.redirect(`/phoenix/employer/v23_4/email-confirm-code-1`)
})

//business-size

router.post('/phoenix/employer/v23_4/business-size', function (req, res) {
        const size = req.session.data['size'];
        if (size === "small") {
                res.redirect('/phoenix/employer/v23_4/turnover');
        } else if (size === "micro") {
                res.redirect('/phoenix/employer/v23_4/turnover');
        } else if (size === "medium") {
                res.redirect('/phoenix/employer/v23_4/turnover-medium');
        } else {
                res.redirect('/phoenix/employer/v23_4/not-eligible-size');
        };
})
...
router.post('/phoenix/employer/v23_4/turnover', function (req, res) {
        ...
        if (turnover == "turnover-eligible") {
                // Send user to next page
                res.redirect('/phoenix/employer/v23_4/you-may-be-eligible')
        }
        if (turnover == "turnover-ineligible") {
                // Send user to next page
                res.redirect('/phoenix/employer/v23_4/balance-sheet')
        }
        // else {
        // // Send user to ineligible page
        // res.redirect('basic-employee-contributions')
...
router.post('/phoenix/employer/v23_4/turnover-medium', function (req, res) {
        ...
        if (turnover == "turnover-ineligible") {
                // Send user to next page
                res.redirect('/phoenix/employer/v23_4/balance-sheet-medium')
        }
        // else {
        // // Send user to ineligible page
        // res.redirect('basic-employee-contributions')
...
router.post('/phoenix/employer/v23_4/balance-sheet', function (req, res) {
        ...
        if (balance == "balance-ineligible") {
                // Send user to next page
                res.redirect('/phoenix/employer/v23_4/not-eligible-balance-sheet')
        }
        // else {
        // // Send user to ineligible page
        // res.redirect('basic-employee-contributions')
...
router.post('/phoenix/employer/v23_4/balance-sheet-medium', function (req, res) {
        ...
        if (balance == "balance-ineligible") {
                // Send user to next page
                res.redirect('/phoenix/employer/v23_4/not-eligible-balance-sheet2')
        }
        // else {
        // // Send user to ineligible page
        // res.redirect('basic-employee-contributions')
...
router.post('/phoenix/employer/v23_4/contact-method', function (req, res) {
        var receiveHow = req.session.data['receiveHow']
        if (receiveHow === "Email") {
                res.redirect('/phoenix/employer/v23_4/email-address')
        }
        if (receiveHow === "Text message") {
                res.redirect('/phoenix/employer/v23_4/mobile-number')
        }
...
router.post('/phoenix/employer/v23_4/email-address', function (req, res) {
        if (req.session.data['rightEmail'] === "Yes") {
                res.redirect('/phoenix/employer/v23_4/check-answers-discount')
        } else {
                res.redirect('/phoenix/employer/v23_4/email')
        }
})

//email recognised

router.post('/phoenix/employer/v23_4/email-recognised', function (req, res) {
        if (req.session.data['detailsFound'] === "yes") {
                res.redirect('/phoenix/employer/v23_4/check-answers')
        } else {
                res.redirect('/phoenix/employer/v23_4/account-homepage-returning')
        }
})

//email changed

router.get(`/phoenix/employer/v23_4/email`, function (req, res) {
        res.render(`/phoenix/employer/v23_4/email`, {
                data: req.session.data
        })
})

router.post(`/phoenix/employer/v23_4/email`, function (req, res) {
        res.redirect(`/phoenix/employer/v23_4/check-answers-discount`)
})

//mobile number

router.post('/phoenix/employer/v23_4/mobile-number', function (req, res) {
        if (req.session.data['rightMobileNumber'] === "Yes") {
                res.redirect('/phoenix/employer/v23_4/check-answers-discount')
        } else {
                res.redirect('/phoenix/employer/v23_4/phone-number')
        }
})

//mobile phone number

router.get(`/phoenix/employer/v23_4/phone-number`, function (req, res) {
        res.render(`/phoenix/employer/v23_4/phone-number`, {
                data: req.session.data
        })
})

router.post(`/phoenix/employer/v23_4/phone-number`, function (req, res) {
        res.redirect(`/phoenix/employer/v23_4/check-answers-discount`)
})
...
router.post('/phoenix/employer/v23_4/contact', function (req, res) {
        const mainName = req.session.data['mainName'];
        if (mainName === "yes") {
                res.redirect('/phoenix/employer/v23_4/employer-name');
        } else {
                res.redirect('/phoenix/employer/v23_4/contact-main-details');
        };
...
router.post('/phoenix/employer/v23_4/discount-code', function (req, res) {
        if (req.session.data['haveRegistered'] === "yes") {
                res.redirect('/phoenix/employer/v23_4/account-homepage-returning')
        } else {
                res.redirect('/phoenix/employer/v23_4/account-homepage-returning')
...
router.post('/phoenix/employer/v23_5/have-you-registered', function (req, res) {
        if (req.session.data['haveRegistered'] === "yes") {
                res.redirect('/phoenix/employer/v24/email-address-gate-returning')
        } else {
                res.redirect('/phoenix/employer/v24/are-you-eligible')
        }
})

//Location

router.post(`/phoenix/employer/v23_5/location`, function (req, res) {
        res.redirect(`/phoenix/employer/v23_5/business-size`)
})

//business-name

router.get(`/phoenix/employer/v23_5/business-name`, function (req, res) {
        res.render(`/phoenix/employer/v23_5/business-name`, {
                data: req.session.data
        })
})

router.post(`/phoenix/employer/v23_5/business-name`, function (req, res) {
        res.redirect(`/phoenix/employer/v23_5/sector`)
})

//sector

router.get(`/phoenix/employer/v23_5/sector`, function (req, res) {
        res.render(`/phoenix/employer/v23_5/sector`, {
                data: req.session.data
        })
})

router.post(`/phoenix/employer/v23_5/sector`, function (req, res) {
        res.redirect(`/phoenix/employer/v23_5/check-answers`)
})

//contact-details
router.get(`/phoenix/employer/v23_5/contact-details`, function (req, res) {
        res.render(`/phoenix/employer/v23_5/contact-details`, {
                data: req.session.data
        })
})

router.post(`/phoenix/employer/v23_5/contact-details`, function (req, res) {
        res.redirect(`/phoenix/employer/v23_5/email-confirm-code-1`)
})

//email-address-gate
router.get(`/phoenix/employer/v23_5/email-address-gate`, function (req, res) {
        res.render(`/phoenix/employer/v23_5/email-address-gate`, {
                data: req.session.data
        })
})

router.post(`/phoenix/employer/v23_5/email-address-gate`, function (req, res) {
        res.redirect(`/phoenix/employer/v23_5/email-confirm-code-1`)
})

//business-size

router.post('/phoenix/employer/v23_5/business-size', function (req, res) {
        const size = req.session.data['size'];
        if (size === "small") {
                res.redirect('/phoenix/employer/v23_5/turnover');
        } else if (size === "micro") {
                res.redirect('/phoenix/employer/v23_5/turnover');
        } else if (size === "medium") {
                res.redirect('/phoenix/employer/v23_5/turnover-medium');
        } else {
                res.redirect('/phoenix/employer/v23_5/not-eligible-size');
        };
})
...
router.post('/phoenix/employer/v23_5/turnover', function (req, res) {
        ...
        if (turnover == "turnover-eligible") {
                // Send user to next page
                res.redirect('/phoenix/employer/v23_5/you-may-be-eligible')
        }
        if (turnover == "turnover-ineligible") {
                // Send user to next page
                res.redirect('/phoenix/employer/v23_5/balance-sheet')
        }
        // else {
        // // Send user to ineligible page
        // res.redirect('basic-employee-contributions')
...
router.post('/phoenix/employer/v23_5/turnover-medium', function (req, res) {
        ...
        if (turnover == "turnover-ineligible") {
                // Send user to next page
                res.redirect('/phoenix/employer/v23_5/balance-sheet-medium')
        }
        // else {
        // // Send user to ineligible page
        // res.redirect('basic-employee-contributions')
...
router.post('/phoenix/employer/v23_5/balance-sheet', function (req, res) {
        ...
        if (balance == "balance-ineligible") {
                // Send user to next page
                res.redirect('/phoenix/employer/v23_5/not-eligible-balance-sheet')
        }
        // else {
        // // Send user to ineligible page
        // res.redirect('basic-employee-contributions')
...
router.post('/phoenix/employer/v23_5/balance-sheet-medium', function (req, res) {
        ...
        if (balance == "balance-ineligible") {
                // Send user to next page
                res.redirect('/phoenix/employer/v23_5/not-eligible-balance-sheet2')
        }
        // else {
        // // Send user to ineligible page
        // res.redirect('basic-employee-contributions')
...
router.post('/phoenix/employer/v23_5/contact-method', function (req, res) {
        var receiveHow = req.session.data['receiveHow']
        if (receiveHow === "Email") {
                res.redirect('/phoenix/employer/v23_5/email-address-discount-code')
        }
        if (receiveHow === "Text message") {
                res.redirect('/phoenix/employer/v23_5/mobile-number')
        }
...
router.post('/phoenix/employer/v23_5/email-address', function (req, res) {
        if (req.session.data['rightEmail'] === "Yes") {
                res.redirect('/phoenix/employer/v23_5/check-answers-discount')
        } else {
                res.redirect('/phoenix/employer/v23_5/email')
        }
})

//email recognised

router.post('/phoenix/employer/v23_5/email-recognised', function (req, res) {
        if (req.session.data['detailsFound'] === "yes") {
                res.redirect('/phoenix/employer/v23_5/check-answers')
        } else {
                res.redirect('/phoenix/employer/v23_5/account-homepage-returning')
        }
})

//email changed

router.get(`/phoenix/employer/v23_5/email`, function (req, res) {
        res.render(`/phoenix/employer/v23_5/email`, {
                data: req.session.data
        })
})

router.post(`/phoenix/employer/v23_5/email`, function (req, res) {
        res.redirect(`/phoenix/employer/v23_5/check-answers-discount`)
})

//mobile number

router.post('/phoenix/employer/v23_5/mobile-number', function (req, res) {
        if (req.session.data['rightMobileNumber'] === "Yes") {
                res.redirect('/phoenix/employer/v23_5/check-answers-discount')
        } else {
                res.redirect('/phoenix/employer/v23_5/phone-number')
        }
})

//mobile phone number

router.get(`/phoenix/employer/v23_5/phone-number`, function (req, res) {
        res.render(`/phoenix/employer/v23_5/phone-number`, {
                data: req.session.data
        })
})

router.post(`/phoenix/employer/v23_5/phone-number`, function (req, res) {
        res.redirect(`/phoenix/employer/v23_5/check-answers-discount`)
})
...
router.post('/phoenix/employer/v23_5/contact', function (req, res) {
        const mainName = req.session.data['mainName'];
        if (mainName === "yes") {
                res.redirect('/phoenix/employer/v23_5/employer-name');
        } else {
                res.redirect('/phoenix/employer/v23_5/contact-main-details');
        };
...
router.post('/phoenix/employer/v23_5/discount-code', function (req, res) {
        if (req.session.data['haveRegistered'] === "yes") {
                res.redirect('/phoenix/employer/v23_5/account-homepage-returning')
        } else {
                res.redirect('/phoenix/employer/v23_5/account-homepage-returning')
...
router.post('/phoenix/employer/v23_5/email-confirm-code-routing', function (req, res) {
        if (req.session.data['returningUser'] === "yes") {
                res.redirect('/phoenix/employer/v23_5/account-homepage-returning')
        } else if (req.session.data['returningUser'] === "list") {
                res.redirect('/phoenix/employer/v23_5/list-filters-mvp')
        }
        else {
                res.redirect('/phoenix/employer/v23_5/are-you-eligible')
        }
})
