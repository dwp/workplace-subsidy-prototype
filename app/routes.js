...
//////////            EMPLOYER    VERSION 14-pp (post-pilot)

//Location

router.post('/phoenix/employer/v14-pp/location', function (req, res) {
        const register = req.session.data['register'];
        if (register === "england") {
                res.redirect('/phoenix/employer/v14-pp/business-size');
       
        } else if (register === "ireland") {
                        res.redirect('/phoenix/employer/v14-pp/not-eligible-location-ni');
        } else {
                res.redirect('/phoenix/employer/v14-pp/not-eligible-location');
        };
    })
    
    //business-size
    
    router.post('/phoenix/employer/v14-pp/business-size', function (req, res) {
        const size = req.session.data['size'];
         if (size === "small") {
                res.redirect('/phoenix/employer/v14-pp/turnover');
        } else if (size === "micro") {
                res.redirect('/phoenix/employer/v14-pp/turnover');
        } else  if (size === "medium") {
                res.redirect('/phoenix/employer/v14-pp/turnover');
        } else {
                res.redirect('/phoenix/employer/v14-pp/not-eligible-size');
        };
    })
    ...
    router.post('/phoenix/employer/v14-pp/turnover', function (req, res) {
        const turnover = req.session.data['turnover'];
         if (turnover === "no") {
                res.redirect('/phoenix/employer/v14-pp/balance-sheet');
    
        } else {
                res.redirect('/phoenix/employer/v14-pp/you-may-be-eligible');
        };
    })
    ...
    router.post('/phoenix/employer/v14-pp/balance-sheet', function (req, res) {
        const balance = req.session.data['balance'];
         if (balance === "no") {
                res.redirect('/phoenix/employer/v14-pp/not-eligible-balance-sheet2');
        } else {
                res.redirect('/phoenix/employer/v14-pp/you-may-be-eligible');
        };
    ...
    router.post('/phoenix/employer/v14-pp/contact-method', function (req, res) {
        const email = req.session.data['email'];
         if (email === "yes") {
                res.redirect('/phoenix/employer/v14-pp/email');
        } else {
                res.redirect('/phoenix/employer/v14-pp/phone-number');
        };
